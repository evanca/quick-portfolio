...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-9272377.224392, 4334752.164846, -7833852.323274, 5086455.576449], maxZoom: 28, minZoom: 1
    })
});


    var searchLayer = new SearchLayer({
      layer: lyr_MD_Mean_Work_Hours_2010_1,
      colName: 'avg_w_E',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([-9272377.224392, 4334752.164846, -7833852.323274, 5086455.576449], map.getSize());
